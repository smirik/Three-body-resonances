...
jupiter.mean_motion = CONFIG['constants']['mean_motion'][5].from_sec_to_rad_year
saturn.mean_motion  = CONFIG['constants']['mean_motion'][6].from_sec_to_rad_year

jupiter.perihelion_longitude = CONFIG['constants']['perihelion_longitude'][5].from_sec_to_rad_year
saturn.perihelion_longitude  = CONFIG['constants']['perihelion_longitude'][6].from_sec_to_rad_year
